...
If you are changing code in `../../core/baker-interface/src/main/scala/com/ing/baker/runtime/model`, see `EFFECT-ABSTRACTION.md` for the local effect-abstraction contract.
