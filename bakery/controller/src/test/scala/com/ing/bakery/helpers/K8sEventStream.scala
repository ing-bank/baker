...
object K8sEventStream {
  ...
  def resource[O <: ObjectResource](implicit system: ActorSystem, cs: ContextShift[IO]): Resource[IO, K8sEventStream[O]] = {
...
class K8sEventStream[O <: ObjectResource](queue: SourceQueueWithComplete[WatchEvent[O]], _source: Source[WatchEvent[O], _])(implicit cs: ContextShift[IO]) {
