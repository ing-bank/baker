...
object BakerService  {
  ...
  def resource(baker: Baker, hostname: InetSocketAddress, apiUrlPrefix: String, interactions: Interactions, loggingEnabled: Boolean)(implicit cs: ContextShift[IO], timer: Timer[IO], ec: ExecutionContext): Resource[IO, Server[IO]] = {
...
final class BakerService private(apiUrlPrefix: String, baker: Baker, interactions: Interactions)(implicit cs: ContextShift[IO], timer: Timer[IO]) extends LazyLogging {
