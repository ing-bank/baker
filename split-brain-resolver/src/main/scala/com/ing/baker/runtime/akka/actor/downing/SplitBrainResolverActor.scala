...
import com.ing.baker.runtime.akka.actor.downing.SplitBrainResolverActor.ActOnSbrDecision
...
private[downing] class SplitBrainResolverActor(stableAfterPeriod: FiniteDuration, strategy: Strategy) extends Actor {
  ...
  val actOnSbrDecisionTask: Cancellable = context.system.scheduler.scheduleAtFixedRate(0 seconds, schedulerTickFrequency, self, ActOnSbrDecision)
