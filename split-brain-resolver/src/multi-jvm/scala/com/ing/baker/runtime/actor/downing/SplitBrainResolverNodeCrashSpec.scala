...
class SplitBrainResolverNodeCrashSpecMultiJvmNodeA extends SplitBrainResolverNodeCrashSpec(SplitBrainResolverConfig(useFailureDetectorPuppet = false, strategyConfig = MajorityStrategyConfig))
class SplitBrainResolverNodeCrashSpecMultiJvmNodeB extends SplitBrainResolverNodeCrashSpec(SplitBrainResolverConfig(useFailureDetectorPuppet = false, strategyConfig = MajorityStrategyConfig))
class SplitBrainResolverNodeCrashSpecMultiJvmNodeC extends SplitBrainResolverNodeCrashSpec(SplitBrainResolverConfig(useFailureDetectorPuppet = false, strategyConfig = MajorityStrategyConfig))
class SplitBrainResolverNodeCrashSpecMultiJvmNodeD extends SplitBrainResolverNodeCrashSpec(SplitBrainResolverConfig(useFailureDetectorPuppet = false, strategyConfig = MajorityStrategyConfig))
class SplitBrainResolverNodeCrashSpecMultiJvmNodeE extends SplitBrainResolverNodeCrashSpec(SplitBrainResolverConfig(useFailureDetectorPuppet = false, strategyConfig = MajorityStrategyConfig))
