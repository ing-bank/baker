...
object BaaSProto {
  ...
  implicit def addRecipeRequestProto(implicit ev0: AkkaSerializerProvider): ProtoMap[AddRecipeRequest, protobuf.AddRecipeRequest] =
  ...
  implicit def getRecipeResponseProto(implicit ev0: AkkaSerializerProvider): ProtoMap[GetRecipeResponse, protobuf.GetRecipeResponse] =
  ...
  implicit def getAllRecipesResponseProto(implicit ev0: AkkaSerializerProvider): ProtoMap[GetAllRecipesResponse, protobuf.GetAllRecipesResponse] =
