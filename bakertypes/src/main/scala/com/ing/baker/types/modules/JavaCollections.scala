...
import com.ing.baker.types.{ListType, ListValue, TypeContext, TypeModule, Value}
...
object JavaCollections {
  ...
  class ListModule extends TypeModule {
    ...
    override def readType(context: TypeContext, javaType: java.lang.reflect.Type) = {
    ...
    override  def toJava(context: TypeContext, value: Value, javaType: java.lang.reflect.Type) = value match {
    ...
    def fromJava(context: TypeContext, obj: Any): Value = obj match {
