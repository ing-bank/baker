...
class RecipeExecutionSpec extends TestRecipeHelper {

  override def actorSystemName = "RecipeExecutionSpec"
  implicit val timeout: FiniteDuration = 10 seconds

  val log = LoggerFactory.getLogger(classOf[RecipeExecutionSpec])
