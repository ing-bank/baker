...
class InMemoryEventStream : EventStream {
    ...
    override fun fetchListeners(): ScalaList<Function1<BakerEvent, BoxedUnit>> =
        ScalaList.from(CollectionHasAsScala(store).asScala()) as ScalaList<Function1<BakerEvent, BoxedUnit>>

    override fun subscribe(listenerFunction: Function1<BakerEvent, BoxedUnit>): Unit {
        store.add(listenerFunction)
    }
}
