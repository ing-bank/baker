...
object RecipeCompiler {
    ...
    ): CompiledRecipe = RecipeCompilerScala.compileRecipe(recipe, validationSettings)

    @JvmStatic
    fun compileRecipe(recipe: Recipe): CompiledRecipe = RecipeCompilerScala.compileRecipe(recipe)
}
