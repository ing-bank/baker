...
object ProcessInstanceProtocol {
  ...
  // Event sourcing events for listener management
  case class CompletionListenerAdded(listenerPath: String) extends BakerSerializable

  case class EventListenerAdded(eventName: String, listenerPath: String) extends BakerSerializable

  case class CompletionListenersRemoved() extends BakerSerializable

  case class EventListenersRemoved(eventName: String) extends BakerSerializable
}
