...
import com.ing.baker.runtime.akka.actor.process_index.{ProcessIndexProtocol => idxProtocol}
import com.ing.baker.runtime.akka.actor.process_instance.{ProcessInstanceProtocol => insProtocol}
