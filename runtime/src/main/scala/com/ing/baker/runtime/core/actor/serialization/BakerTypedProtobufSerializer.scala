package com.ing.baker.runtime.core.actor.serialization

import akka.actor.ExtendedActorSystem
import akka.serialization.SerializerWithStringManifest
import com.ing.baker.il
import com.ing.baker.runtime.core.actor.ClusterBakerActorProvider.GetShardIndex
import com.ing.baker.runtime.core.actor.process_index.ProcessIndex._
...
import com.ing.baker.runtime.core.actor.process_index.ProcessEventReceiverProto._
import com.ing.baker.runtime.core.actor.process_index.ProcessEventReceiver
import com.ing.baker.runtime.core.actor.process_instance.ProcessInstanceProtocol
import com.ing.baker.runtime.core.actor.process_instance.ProcessInstanceProto._
import com.ing.baker.runtime.core.actor.recipe_manager.RecipeManager.RecipeAdded
import com.ing.baker.runtime.core.actor.recipe_manager.RecipeManagerProtocol._
import com.ing.baker.runtime.core.actor.recipe_manager.RecipeManagerProto._
...
object BakerTypedProtobufSerializer {
  ...
  def entries(implicit ev0: SerializersProvider): List[BinarySerializable] = List(
    ...
    forType[com.ing.baker.runtime.core.actor.process_instance.protobuf.TransitionFired].register("TransitionFired")(ProtoMap.identityProtoMap(com.ing.baker.runtime.core.actor.process_instance.protobuf.TransitionFired)),
    forType[com.ing.baker.runtime.core.actor.process_instance.protobuf.TransitionFailed].register("TransitionFailed")(ProtoMap.identityProtoMap(com.ing.baker.runtime.core.actor.process_instance.protobuf.TransitionFailed)),
    forType[com.ing.baker.runtime.core.actor.process_instance.protobuf.Initialized].register("Initialized")(ProtoMap.identityProtoMap(com.ing.baker.runtime.core.actor.process_instance.protobuf.Initialized)),
