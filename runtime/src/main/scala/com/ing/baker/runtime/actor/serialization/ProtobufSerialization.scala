...
/**
  * This class is responsible for translating the EventSourcing.Event to and from the messages.Event
  *
  * (which is generated by scalaPB and serializes to protobuf)
  */
class ProtobufSerialization[P[_], T[_, _], S](serializer: ObjectSerializer)(implicit placeIdentifier: Identifiable[P[_]], transitionIdentifier: Identifiable[T[_, _]]) {
