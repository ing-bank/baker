...
/**
  ...
  */
class ProcessInstanceSerialization[P[_], T, S, E](serializer: ObjectSerializer)(implicit placeIdentifier: Identifiable[P[_]], transitionIdentifier: Identifiable[T]) {
