...
class SplitBrainResolverMultiJvmNodeA extends SplitBrainResolverSpec(SplitBrainResolverConfig())
class SplitBrainResolverMultiJvmNodeB extends SplitBrainResolverSpec(SplitBrainResolverConfig())
class SplitBrainResolverMultiJvmNodeC extends SplitBrainResolverSpec(SplitBrainResolverConfig())
class SplitBrainResolverMultiJvmNodeD extends SplitBrainResolverSpec(SplitBrainResolverConfig())
class SplitBrainResolverMultiJvmNodeE extends SplitBrainResolverSpec(SplitBrainResolverConfig())
